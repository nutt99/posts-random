...
<style>
    body {
        ...
        /* Pinterest dominan putih untuk halaman profil */
    ...
    .tab-item.active {
        ...
        border-radius: 0;
        /* Menghilangkan radius agar garis bawahnya rata */
    }

    /* --- STYLING MASONRY GRID --- */
    .masonry-grid-full {
        column-count: 5;
        /* Default 5 kolom untuk profil */
        column-gap: 16px;
        padding: 0 20px;
    }
    ...
    .masonry-item:hover img {
        ...
        /* Gambar sedikit gelap saat di-hover */
    }
